...
#define TFT_I2C_POWER  7 // Replace 10 with the actual GPIO pin number used for I2C power. MetroESP32-S2/7
...
#define DEFAULT_I2C_PORT &Wire1 // QT Py QWIIC port uses Wire1 - Carlos
